...
export function CompaniesProvider({ children }) {
  ...
  useEffect(() => {
    ...
    async function getForeingInvestment() {
      try {
        const response = await eraInstance.get(
          "/era-companies/foreing-invesment"
        );
    ...
    async function getGovInstRelationship() {
      try {
        const response = await eraInstance.get(
          "/era-companies/gov-inst-relationship"
        );
    ...
    async function getGovRepRelationship() {
      try {
        const response = await eraInstance.get(
          "/era-companies/gov-rep-relationship"
        );
    ...
    async function getLinkedPeopleByCountry() {
      try {
        const response = await eraInstance.get(
          "/era-companies/linked-people-by-country"
        );
